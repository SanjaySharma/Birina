package com.example.birina.track.disabledevice.service;
...
import com.example.birina.track.disabledevice.Lockscreen;
...
//        sIsSoftKeyEnable = SharedPreferencesUtil.get(Lockscreen.ISSOFTKEY);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.d(Constant.TAG, "Enter in onStartCommand of LockscreenViewService ");
        ...
        if (isLockScreenAble()) {
            ...
            Log.d(Constant.TAG, "Exit from onStartCommand of LockscreenViewService ");
    ...
    private boolean isLockScreenAble() {
        ...
        Log.d(Constant.TAG, "Enter in isLockScreenAble of LockscreenViewService ");
        ...
        Log.d(Constant.TAG, "Exit from isLockScreenAble of LockscreenViewService isLock: "+isLock);
